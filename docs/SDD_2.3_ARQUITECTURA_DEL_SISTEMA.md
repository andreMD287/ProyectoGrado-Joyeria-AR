...
| **Alta** | Migrar el render de la prueba virtual a `three_js` (ADR-16) | Motor validado por spike; falta portar el overlay, alimentar la cámara virtual con la pose de la muñeca y añadir el *occluder* de la extremidad. Requiere además instalar `cmake;3.31.4` en el CI |
...
| Hecho (doc) | Tres ejes de dominio, ADR 01–16 (microkernel §2.2.1, landmarks métricos ADR-14/15, motor de render ADR-16), escenarios EC-01…06, rename Fallback | Cubierto en este SDD |
