...
| **Alta** | El render se percibe **superpuesto**, no puesto sobre el cuerpo | Verificado en dispositivo (2026-09-18): `model_viewer_plus` renderiza desde *su* cámara y el resultado se compone como sprite 2D, así que no hay relación de perspectiva con la extremidad. Un recorte 2D se probó y no basta. Requiere cámara virtual que imite la del teléfono y, con ella, oclusión por buffer de profundidad |
...
| Hecho (doc) | Tres ejes de dominio, ADR 01–15 (microkernel §2.2.1, landmarks métricos ADR-14/15), escenarios EC-01…06, rename Fallback | Cubierto en este SDD |
