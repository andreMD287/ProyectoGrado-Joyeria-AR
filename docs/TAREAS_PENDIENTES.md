...
- Entorno de desarrollo iOS operativo (Mac Mini y MacBook Air M4); build, instalación y ejecución confirmadas en iPhone físico en modo debug.
...
- **Validación end-to-end en iPhone 15 (iOS 26.5):** las tres categorías funcionan correctamente — pulseras (muñeca vía Apple Vision), aretes (lóbulo vía ML Kit) y collares (hombros vía ML Kit), incluyendo iniciar y detener la sesión de tracking repetidamente sin crashear.
